...
public class NuevaMascota extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Código de los Edit
		editNombre = (EditText) findViewById(R.id.editTxtNombreNuevaMascota);
		editTipo = (EditText) findViewById(R.id.editTxtTipoNuevaMascota);
		editRaza = (EditText) findViewById(R.id.editTxtRazaNuevaMascota);
		editSexo = (EditText) findViewById(R.id.editTxtSexoNuevaMascota);
		editFecha = (EditText) findViewById(R.id.editTxtFechaNuevaMascota);
		editPropietario = (EditText) findViewById(R.id.editTxtPropietarioNuevaMascota);
	...
	public void pulsaAceptar(View view){
		...
		if(flag){
			...
			MainActivity.almacen.nuevaMascota(mascota,id_prop);
			Toast.makeText(this, "Nueva mascota dada de alta", Toast.LENGTH_SHORT).show();
			finish();
		}
		else{
